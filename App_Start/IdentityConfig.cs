...
namespace TheAgency
{
    public class EmailService : IIdentityMessageService
    {
        ...
        private Task SendMail(IdentityMessage message)
        {
            ...
            msg.From = new MailAddress("noreply@theagencyonline.com");
            ...
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("malvern1111@googlemail.com", "Charlie#50434640");
